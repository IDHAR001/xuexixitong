...
public class KaoqinqingjiaEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public KaoqinqingjiaEntity() {

	}

	public KaoqinqingjiaEntity(T t) {
		try {
    ...
    public String toString() {
        return "Kaoqinqingjia{" +
            "id=" + id +
            ", kechnegkaoqinUuidNumber=" + kechnegkaoqinUuidNumber +
            ", xueshengId=" + xueshengId +
            ", kaoqinqingjiaText=" + kaoqinqingjiaText +
            ", kaoqinqingjiaTypes=" + kaoqinqingjiaTypes +
            ", kechnegkaoqinId=" + kechnegkaoqinId +
