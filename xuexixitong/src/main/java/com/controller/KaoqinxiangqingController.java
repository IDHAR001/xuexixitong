    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(kaoqinxiangqing !=null){
            ...
            BeanUtils.copyProperties( kaoqinxiangqing , view );//把实体数据重构到view中
                ...
                //级联表
                XueshengEntity xuesheng = xueshengService.selectById(kaoqinxiangqing.getXueshengId());
                if(xuesheng != null){
    ...
    */
    ...
    public R save(@RequestBody KaoqinxiangqingEntity kaoqinxiangqing, HttpServletRequest request){
        ...
        if(StringUtil.isEmpty(role))
            ...
            kaoqinxiangqing.setXueshengId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        Wrapper<KaoqinxiangqingEntity> queryWrapper = new EntityWrapper<KaoqinxiangqingEntity>()
            .eq("kechnegkaoqin_uuid_number", kaoqinxiangqing.getKechnegkaoqinUuidNumber())
            .eq("xuesheng_id", kaoqinxiangqing.getXueshengId())
            .eq("kaoqin_types", kaoqinxiangqing.getKaoqinTypes())
            ;
