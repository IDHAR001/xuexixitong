    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                                ...
                                <el-col :span="24">
                                    <el-form-item v-if="type!='info'"  class="input" label="考试结束时间" prop="exampaperTime">
                                        <el-date-picker
                                                value-format="yyyy-MM-dd HH:mm:ss"
                                                v-model="ruleForm.exampaperTime"
                                                type="datetime"
                                                placeholder="考试结束时间">
                                        </el-date-picker>
                                    </el-form-item>
                                    <div v-else>
                                        <el-form-item v-if="ruleForm.exampaperTime" label="考试结束时间" prop="exampaperTime">
                                            <span v-html="ruleForm.exampaperTime"></span>
                                        </el-form-item>
                                    </div>
                                </el-col>
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='exampaperTime'){
                          this.ruleForm.exampaperTime = obj[o];
                          this.ro.exampaperTime = true;
                          continue;
                      }
                      if(o=='exampaperDelete'){
                          this.ruleForm.exampaperDelete = obj[o];
                          this.ro.exampaperDelete = true;
                          continue;
                      }
                    }
                }
