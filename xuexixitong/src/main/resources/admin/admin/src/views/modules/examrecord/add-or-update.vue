            ...
            <el-row>
                                    ...
                                    <el-col :span="12">
                                        <el-form-item class="select" v-if="type!='info'"  label="学生" prop="xueshengId">
                                            <el-select v-model="ruleForm.xueshengId" placeholder="请选择学生" @change="xueshengChange">
                                                <el-option
                                    ...
                                    <el-col :span="12">
                                        <el-form-item class="input" v-if="type!='info'"  label="学生姓名" prop="xueshengName">
                                            <el-input v-model="xueshengForm.xueshengName"
                                                      placeholder="学生姓名" clearable  :readonly="ro.xueshengName" readonly></el-input>
                                        </el-form-item>
                                        <div v-else>
                                    ...
                                    <el-col :span="12">
                                        <el-form-item class="input" v-if="type!='info'"  label="身份证号" prop="xueshengIdNumber">
                                            <el-input v-model="xueshengForm.xueshengIdNumber"
                                                      placeholder="身份证号" clearable  :readonly="ro.xueshengIdNumber" readonly></el-input>
                                        </el-form-item>
                                        <div v-else>
                                    ...
                                    <el-col :span="12">
                                        <el-form-item class="input" v-if="type!='info'"  label="手机号" prop="xueshengPhone">
                                            <el-input v-model="xueshengForm.xueshengPhone"
                                                      placeholder="手机号" clearable  :readonly="ro.xueshengPhone" readonly></el-input>
                                        </el-form-item>
                                        <div v-else>
                                    ...
                                    <el-col :span="12">
                                        <el-form-item class="input" v-if="type!='info'"  label="邮箱" prop="xueshengEmail">
                                            <el-input v-model="xueshengForm.xueshengEmail"
                                                      placeholder="邮箱" clearable  :readonly="ro.xueshengEmail" readonly></el-input>
                                        </el-form-item>
                                        <div v-else>
                                            <el-form-item class="input" label="邮箱" prop="xueshengEmail">
