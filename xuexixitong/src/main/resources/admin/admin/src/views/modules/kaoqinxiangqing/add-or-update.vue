                                ...
                                <input id="xueshengId" name="xueshengId" type="hidden">
                                 <el-col :span="12">
                                     <el-form-item class="select" v-if="type!='info'"  label="考勤状态" prop="kaoqinTypes">
                                         <el-select v-model="ruleForm.kaoqinTypes" placeholder="请选择考勤状态">
                                             <el-option
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   xueshengId: [
                              { required: true, message: '考勤学生不能为空', trigger: 'blur' },
                          ],
                   kaoqinTypes: [
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='kaoqinTypes'){
                          this.ruleForm.kaoqinTypes = obj[o];
                          this.ro.kaoqinTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
