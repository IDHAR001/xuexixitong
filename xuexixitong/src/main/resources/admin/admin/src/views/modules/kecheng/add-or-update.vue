        ...
        >
            <el-row>
                                ...
                                <input id="jiaoshiId" name="jiaoshiId" type="hidden">
                                 <el-col :span="12">
                                     <el-form-item class="select" v-if="type!='info'"  label="上课班级" prop="banjiTypes">
                                         <el-select v-model="ruleForm.banjiTypes" placeholder="请选择上课班级">
                                             <el-option
                                     ...
                                     <div v-else>
                                         <el-form-item class="input" label="上课班级" prop="banjiValue">
                                             <el-input v-model="ruleForm.banjiValue"
                                                       placeholder="上课班级" readonly></el-input>
                                         </el-form-item>
                                     </div>
                                 </el-col>
                                <el-col :span="24">
                                ...
                                <el-col :span="24">
                                    <el-form-item v-if="type!='info'"  class="input" label="下课时间" prop="xiakeTime">
                                        <el-time-select
                                    ...
                                    <div v-else>
                                        <el-form-item v-if="ruleForm.xiakeTime" label="下课时间" prop="xiakeTime">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   banjiTypes: [
                              { required: true, message: '上课班级不能为空', trigger: 'blur' },
                          ],
                   shangkeTime: [
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='shangkeTime'){
                          this.ruleForm.shangkeTime = obj[o];
                          this.ro.shangkeTime = true;
                          continue;
                      }
                      if(o=='xiakeTime'){
                          this.ruleForm.xiakeTime = obj[o];
                          this.ro.xiakeTime = true;
                          continue;
                      }
                    }
                }
            ...
            // 提交
            onSubmit() {
				if(this.ruleForm.shangkeTime >= this.ruleForm.xiakeTime){
					this.$message.error('下课时间不能或小于上课时间！');
					return false;
				}
